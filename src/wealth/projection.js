...
import { EPISTEMIC } from '../kernel/floors.js';
 ...
 */
export function projectCompoundGrowth(pv, rateAnnual, years, uncertaintyBand = 0.08) {
 ...
 * @returns {Object}
 */
export function projectRunwayDepletion(liquidAssets, monthlyBurn, monthlyIncome = 0) {
